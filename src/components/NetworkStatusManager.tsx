...
function OfflineBanner() {
  return (
    <div className="fixed bottom-[calc(var(--mobile-nav-height)+env(safe-area-inset-bottom))] md:bottom-0 left-0 right-0 bg-slate-900 text-white p-3 z-40 shadow-2xl border-t-2 border-red-600">
